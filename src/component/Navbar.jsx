      ...
      <div className="container-fluid d-flex align-items-center">
        ...
        <div className="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
          <ul className="navbar-nav align-items-center justify-content-center navlist_gap flex-wrap">
            ...
            <li className="nav-item"> <Link to="/" className=" text-black  text-decoration-none"> About Us </Link> </li>
            ...
            <li className="nav-item"> <Link to="/" className=" btn nav_loginbtn text-white text-decoration-none"> Login </Link> </li>
            ...
            <li className="nav-item"> <Link to="/" className="  text-decoration-none"> <img src={person} alt="Profile" className="icon-img profile-btn" /> </Link> </li>
